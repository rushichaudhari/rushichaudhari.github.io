...
class HugoArticle(object):
    ...
    def __init__(self, article, published= False, series=None):
        ...
        for relative_image_path in relative_image_paths:
            image = os.path.join('https://raw.githubusercontent.com/rushichaudhari/rushichaudhari.github.io/main/static/img', relative_image_path[1])
...
if __name__ == "__main__":
    ...
    for file in files:
        ...
        result = requests.post(url=url, json=json.loads(data), headers={"api_key": os.enviorn["DEVTO_TOKEN"]})
        print(file)